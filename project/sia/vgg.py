...
class VGG16:
    def __init__(self):
        ...
        self.block1_pool = MaxPooling2D((3,3), strides = (2,2), name = 'block1_pool')
        ...
        self.block2_pool = MaxPooling2D((3,3),strides = (2,2),name = 'block2_pool')
        ...
        self.block3_pool = MaxPooling2D((3,3),strides = (2,2),name = 'block3_pool')
        ...
        self.block4_pool = MaxPooling2D((3,3),strides = (2,2),name = 'block4_pool')
