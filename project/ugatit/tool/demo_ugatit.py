...
if __name__ == '__main__':
    ...
    parser.add_argument('--type', type=str, default='ugatit')
    parser.add_argument('--resume', type=str, default='F:/WCY-code-all/wcy3/Morph-UGATIT-self/ckpt/145.pt')
    parser.add_argument('--input', type=str, default='F:/WCY-code-all/wcy3/Morph-UGATIT-self/dataset/skull2skin/testA')
    parser.add_argument('--saved-dir', default='F:/WCY-code-all/wcy3/Morph-UGATIT-self/result', type=str)
    ...
    image_path = r"E:\pycharmnote\python\jiemian\self\skull.png"
