...
from models.ugatit_plus_sia import UGATITPlus
from configs.cfgs_ugatit_plus_sia import cfgs
import torch
...
class Train:
    ...
    _defaults = {
        "model_path": "/root/wcy/Morph-UGATIT-self/training/ep017-loss0.000-val_loss0.621.h5",
